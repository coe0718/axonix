//! Formatting and analysis helpers for `PredictionStore`.
//!
//! These methods do not touch storage state — they compute and format
//! data for display and system-prompt injection.
