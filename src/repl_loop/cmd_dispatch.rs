//! Handles the output of `handle_command()` for Handled and NotACommand results.
//!
//! These handlers need live session data (agent messages, session_start, cwd)
//! and async I/O (GitHub comment posting, Bluesky recap, review dispatch).
